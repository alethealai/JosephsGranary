...
![carousel Image](./img/carousel.png)
![Progress Bar](./img/progress%20bar.png)
![search bar Image](./img/search%20bar.png)
## Project Structure
...
To build the final jar and optimize the josephsGranary application for production, run:
